...
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.profile.UserDetailFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsAccountFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsCirclesFoldersFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsICSingleCircleFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsICTimelineFeedFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsPrivacySelectionFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsSecurityLegacy2StepFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.settings.SettingsSecurityLegacyContactTriggerFragment;
...
public class HLServerCalls {
	...
	public static Object[] signUp(Context context, String fName, String sName, String email,
		...
		if (Utils.areStringsValid(email, password, fName, sName)) {
			...
			pairs.add(new Pair<>("birthDate", Utils.formatDateForDB(dob)));
			pairs.add(new Pair<>("g", gender == LoginActivity.Gender.MALE ? "Male" : "Female"));
...
//	}
	 ...
	 * {@link rs.highlande.highlanders_app.activities_and_fragments.activities_home.profile.ProfileHelper.ProfileType#FRIEND}.
	 * @param interestIdToFetch must always refer to the {@link rs.highlande.highlanders_app.models.Interest} to be fetched.
