...
//		}
	 ...
	 *
	 * @param toolbar     {@link rs.highlande.highlanders_app.activities_and_fragments.activities_home.HomeActivity}'s {@link Toolbar}.
	 * @param bottomBar   {@link rs.highlande.highlanders_app.activities_and_fragments.activities_home.HomeActivity}'s bottom bar {@link View}.
...
//						maskLower.setVisibility(View.GONE);
	...
	/**
	 * Tells whether the current {@link rs.highlande.highlanders_app.utility.helpers.FullScreenHelper.FullScreenType}
	...
	/**
	 * Tells whether the helper has been invoked from {@link rs.highlande.highlanders_app.activities_and_fragments.activities_home.timeline.TimelineFragment} displaying a user's or not.
	 *
	 * @return True if the helper is in single mode, false otherwise.
	 */
