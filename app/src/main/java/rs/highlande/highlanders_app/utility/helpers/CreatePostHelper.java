...
package rs.highlande.highlanders_app.utility.helpers;
...
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.AudioRecordFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.CreatePostPreviewActivity;
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.GalleryFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.InitiativesFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.PostVisibilityActivity;
import rs.highlande.highlanders_app.activities_and_fragments.activities_create_post.TagFragment;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.HomeActivity;
import rs.highlande.highlanders_app.activities_and_fragments.activities_home.wishes.WishCreatePostFragment;
import rs.highlande.highlanders_app.adapters.BasicAdapterInteractionsListener;
import rs.highlande.highlanders_app.adapters.CustomGalleryAdapter;
import rs.highlande.highlanders_app.adapters.SearchAdapter;
import rs.highlande.highlanders_app.adapters.TagAdapter;
...
import rs.highlande.highlanders_app.services.DeleteTempFileService;
...
import rs.highlande.highlanders_app.utility.FlingGestureListener;
...
//				Toast.makeText(activity, "Go to identity selection", Toast.LENGTH_SHORT).show();
	...
	private void configurePostToolbar(View view) {
		if (view != null) {
			...
			galleryLayout.setLayoutParams(lpCamera);
			audioRecLayout.setLayoutParams(lpCamera);
			tagLayout.setLayoutParams(lpCamera);
		}
	}
