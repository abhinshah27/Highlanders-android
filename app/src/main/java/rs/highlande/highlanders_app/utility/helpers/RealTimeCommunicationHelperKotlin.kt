...
import rs.highlande.highlanders_app.activities_and_fragments.activities_chat.ChatMessagesFragment
...
import rs.highlande.highlanders_app.base.BaseSingletonWithArgument
import rs.highlande.highlanders_app.base.HLActivity
import rs.highlande.highlanders_app.base.HLApp
import rs.highlande.highlanders_app.models.*
...
import rs.highlande.highlanders_app.utility.*
import rs.highlande.highlanders_app.utility.realm.RealmUtils
import rs.highlande.highlanders_app.websocket_connection.*
import java.util.*
        ...
        if (json != null) {
            ...
            mRealm?.executeTransaction {
                ...
                if (roomPair.first) {
                    ...
                    // INFO: 2019-05-23    Assigns correct ownerID (if message received it cannot be the user's) and fixes wrong call to Room initialization onNewMessage received
                    room = ChatRoom(
                            message.senderID,
