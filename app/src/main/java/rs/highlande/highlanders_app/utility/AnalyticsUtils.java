...
/**
 * Basic class dedicated to the action of sending analytics to Google through Google Analytics SDK.
 *
...
public class AnalyticsUtils {
	...
	/**
	 * Send info for tracked screen to GoogleAnalytics
	...
	public static void trackScreen(Context context, String screenName) {
		if (!BuildConfig.DEBUG && Utils.isContextValid(context)) {
			HLApp application = (HLApp) context.getApplicationContext();
