...
/**
 * @value "hfu74365ksdg0wrnhq52FUW#$(kjdhgf"
 */
const val MEDIA_UPLOAD_VALUE = "hfu74365ksdg0wrnhq52FUW#$(kjdhgf"
...
class MediaUploadManager(context: Context,
    ...
    inner class UploadService(private val activity: HLActivity) {
         ...
         * @param userId   the [rs.highlande.highlanders_app.models.HLUser._id] of the user uploading the picture.
