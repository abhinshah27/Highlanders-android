...
/**
 * Enum class referring to the available colors to style a [rs.highlande.highlanders_app.models.Post]
...
/**
 * Enum class referring to the available text sizes for a [rs.highlande.highlanders_app.models.Post]
 * message.
 */
...
/**
 * Enum class referring to the available positions for a [rs.highlande.highlanders_app.models.Post]
 * message.
 */
