...
import kotlinx.android.synthetic.main.hl_toolbar_transp_wv_doc.view.*
...
class WebViewActivityDocuments : HLActivity(), ShareHelper.ShareableProvider {
    ...
    override fun onResume() {
        ...
        toolbar.shareBtn.visibility = if (!getPostOrMessageID().isBlank()) View.VISIBLE else View.GONE
    }
