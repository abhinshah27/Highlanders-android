...
import rs.highlande.highlanders_app.adapters.InteractionCommentsAdapter;
import rs.highlande.highlanders_app.adapters.InteractionHeartsAdapter;
import rs.highlande.highlanders_app.adapters.InteractionSharesAdapter;
...
import rs.highlande.highlanders_app.utility.SlidingPanelHandler;
...
import rs.highlande.highlanders_app.utility.helpers.RealTimeCommunicationListener;
...
//			else
//				colorRes = mPost.isYouLeftComments() ? R.color.hl_orange_alpha_med : R.color.white_50;
...
//						sUp = false;
	...
	private void handleTransitionDrawables(boolean first) {
		...
		@ColorRes int colorInactiveOrange = R.color.hl_orange_alpha_med;
